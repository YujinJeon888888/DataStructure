...
//	if (root) {
//		binaryTreeToBST(root->left); //왼쪽 서브트리 순회
//
//		//중위순회하며 노드방문하고, 그 노드방문한 수를 이진탐색트리 insert_node로
//		binary_tree_to_BST = insert_node(binary_tree_to_BST, root->key);
//
//		binaryTreeToBST(root->right);//오른쪽 서브트리 순회
//	}
//}
//
//int main(void) {
...
//
//	root = binary_tree_to_BST;//코드추가(루트에 바뀐 구조체 대입)
//
//	printInorder(root);
//
//	return 0;
